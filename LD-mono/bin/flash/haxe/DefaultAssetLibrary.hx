...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/P2_Joy_Ctrl.png", __ASSET__graphics_p2_joy_ctrl_png);
		...
		className.set ("audio/EndGame.mp3", __ASSET__audio_endgame_mp3);
		type.set ("audio/EndGame.mp3", AssetType.MUSIC);
		className.set ("audio/huuang.mp3", __ASSET__audio_huuang_mp3);
		type.set ("audio/huuang.mp3", AssetType.MUSIC);
		className.set ("audio/Pickup.mp3", __ASSET__audio_pickup_mp3);
		type.set ("audio/Pickup.mp3", AssetType.MUSIC);
		className.set ("audio/splat.mp3", __ASSET__audio_splat_mp3);
		type.set ("audio/splat.mp3", AssetType.MUSIC);
		className.set ("audio/StartGame.mp3", __ASSET__audio_startgame_mp3);
		type.set ("audio/StartGame.mp3", AssetType.MUSIC);
		className.set ("audio/theme.mp3", __ASSET__audio_theme_mp3);
		type.set ("audio/theme.mp3", AssetType.MUSIC);
...
@:keep @:bind #if display private #end class __ASSET__audio_endgame_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__audio_huuang_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__audio_pickup_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__audio_splat_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__audio_startgame_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__audio_theme_mp3 extends flash.media.Sound { }
...
//@:sound("assets/audio/EndGame.mp3") class __ASSET__audio_endgame_mp3 extends openfl.media.Sound {}
//@:sound("assets/audio/huuang.mp3") class __ASSET__audio_huuang_mp3 extends openfl.media.Sound {}
//@:sound("assets/audio/Pickup.mp3") class __ASSET__audio_pickup_mp3 extends openfl.media.Sound {}
//@:sound("assets/audio/splat.mp3") class __ASSET__audio_splat_mp3 extends openfl.media.Sound {}
//@:sound("assets/audio/StartGame.mp3") class __ASSET__audio_startgame_mp3 extends openfl.media.Sound {}
//@:sound("assets/audio/theme.mp3") class __ASSET__audio_theme_mp3 extends openfl.media.Sound {}
