...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("graphics/P1_Key_Ctrl.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("graphics/P2_Joy_Ctrl.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("audio/EndGame.mp3");
		types.push (AssetType.MUSIC);
		
		
		urls.push ("audio/huuang.mp3");
		types.push (AssetType.MUSIC);
		
		
		urls.push ("audio/Pickup.mp3");
		types.push (AssetType.MUSIC);
		
		
		urls.push ("audio/splat.mp3");
		types.push (AssetType.MUSIC);
		
		
		urls.push ("audio/StartGame.mp3");
		types.push (AssetType.MUSIC);
		
		
		urls.push ("audio/theme.mp3");
		types.push (AssetType.MUSIC);
