...
Dynamic List_obj::first( ){
	HX_STACK_FRAME("List","first",0x898acc40,"List.first","/usr/lib/haxe/std/List.hx",82,0xd5566cff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	if (((this->h == null()))){
		HX_STACK_LINE(82)
...
Dynamic List_obj::last( ){
	HX_STACK_FRAME("List","last",0xe901e846,"List.last","/usr/lib/haxe/std/List.hx",91,0xd5566cff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
	if (((this->q == null()))){
		HX_STACK_LINE(91)
