...
::Xml Xml_obj::parse( ::String str){
	HX_STACK_FRAME("Xml","parse",0x8a44f23c,"Xml.parse","/usr/lib/haxe/std/cpp/_std/Xml.hx",46,0x13595685)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::Xml &x){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/cpp/_std/Xml.hx",49,0x13595685)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				...
				Void run(::String name,Dynamic att){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","/usr/lib/haxe/std/cpp/_std/Xml.hx",51,0x13595685)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","/usr/lib/haxe/std/cpp/_std/Xml.hx",64,0x13595685)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_3",0x5201af7a,"*._Function_2_3","/usr/lib/haxe/std/cpp/_std/Xml.hx",71,0x13595685)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(72)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_4",0x5201af7b,"*._Function_2_4","/usr/lib/haxe/std/cpp/_std/Xml.hx",78,0x13595685)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(79)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_5",0x5201af7c,"*._Function_2_5","/usr/lib/haxe/std/cpp/_std/Xml.hx",92,0x13595685)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(93)
				...
				Void run(){
					HX_STACK_FRAME("*","_Function_2_6",0x5201af7d,"*._Function_2_6","/usr/lib/haxe/std/cpp/_std/Xml.hx",101,0x13595685)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(101)
