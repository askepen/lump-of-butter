...
hx::ObjectPtr< __ASSET__font_04b_03___ttf_obj > __ASSET__font_04b_03___ttf_obj::__new(::String __o_filename,::openfl::_v2::text::FontStyle style,::openfl::_v2::text::FontType type)
