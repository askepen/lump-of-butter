...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("graphics/Arrow.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("graphics/dust.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/FlashTip.png", "graphics/FlashTip.png");
			type.set ("graphics/FlashTip.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("graphics/ModeMultiplayer.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/ModeSingleplayerP1.png", "graphics/ModeSingleplayerP1.png");
			type.set ("graphics/ModeSingleplayerP1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/ModeSingleplayerP2.png", "graphics/ModeSingleplayerP2.png");
			type.set ("graphics/ModeSingleplayerP2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/P1_Joy_Ctrl.png", "graphics/P1_Joy_Ctrl.png");
			type.set ("graphics/P1_Joy_Ctrl.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/P1_Key_Ctrl.png", "graphics/P1_Key_Ctrl.png");
			type.set ("graphics/P1_Key_Ctrl.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/P2_Joy_Ctrl.png", "graphics/P2_Joy_Ctrl.png");
			type.set ("graphics/P2_Joy_Ctrl.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/P2_Key_Ctrl.png", "graphics/P2_Key_Ctrl.png");
			type.set ("graphics/P2_Key_Ctrl.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/Paused.png", "graphics/Paused.png");
			type.set ("graphics/Paused.png", Reflect.field (AssetType, "image".toUpperCase ()));
