...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("graphics/Arrow.png", "graphics/Arrow.png");
		...
		path.set ("graphics/ModeMultiplayer.png", "graphics/ModeMultiplayer.png");
		type.set ("graphics/ModeMultiplayer.png", AssetType.IMAGE);
		path.set ("graphics/ModeSingleplayerP1.png", "graphics/ModeSingleplayerP1.png");
		type.set ("graphics/ModeSingleplayerP1.png", AssetType.IMAGE);
		path.set ("graphics/ModeSingleplayerP2.png", "graphics/ModeSingleplayerP2.png");
		type.set ("graphics/ModeSingleplayerP2.png", AssetType.IMAGE);
		path.set ("graphics/P1_Joy_Ctrl.png", "graphics/P1_Joy_Ctrl.png");
		type.set ("graphics/P1_Joy_Ctrl.png", AssetType.IMAGE);
		path.set ("graphics/P1_Key_Ctrl.png", "graphics/P1_Key_Ctrl.png");
		type.set ("graphics/P1_Key_Ctrl.png", AssetType.IMAGE);
		path.set ("graphics/P2_Joy_Ctrl.png", "graphics/P2_Joy_Ctrl.png");
		type.set ("graphics/P2_Joy_Ctrl.png", AssetType.IMAGE);
		path.set ("graphics/P2_Key_Ctrl.png", "graphics/P2_Key_Ctrl.png");
		type.set ("graphics/P2_Key_Ctrl.png", AssetType.IMAGE);
		path.set ("graphics/Paused.png", "graphics/Paused.png");
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "graphics/P1_Key_Ctrl.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "graphics/P2_Joy_Ctrl.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:keep #if display private #end class __ASSET__graphics_debug_console_debug_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_hidden_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_logo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_output_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_pause_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_play_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_step_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_debug_console_visible_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__graphics_preloader_haxepunk_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep #if display private #end class __ASSET__font_04b_03___ttf extends null { }
@:keep #if display private #end class __ASSET__font_04b_03___ttf_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep #if display private #end class __ASSET__font_5 extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "font/04B_03__.ttf"; } #end }
...
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_debug.png") #if display private #end class __ASSET__graphics_debug_console_debug_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_hidden.png") #if display private #end class __ASSET__graphics_debug_console_hidden_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_logo.png") #if display private #end class __ASSET__graphics_debug_console_logo_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_output.png") #if display private #end class __ASSET__graphics_debug_console_output_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_pause.png") #if display private #end class __ASSET__graphics_debug_console_pause_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_play.png") #if display private #end class __ASSET__graphics_debug_console_play_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_step.png") #if display private #end class __ASSET__graphics_debug_console_step_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_visible.png") #if display private #end class __ASSET__graphics_debug_console_visible_png extends flash.display.BitmapData {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/graphics/preloader/haxepunk.png") #if display private #end class __ASSET__graphics_preloader_haxepunk_png extends flash.display.BitmapData {}
@:font("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/font/04B_03__.ttf") #if display private #end class __ASSET__font_04b_03___ttf extends flash.text.Font {}
@:bitmap("/usr/lib/haxe/lib/HaxePunk/2,5,3/assets/font/04B_03__.ttf.png") #if display private #end class __ASSET__font_04b_03___ttf_png extends flash.display.BitmapData {}
